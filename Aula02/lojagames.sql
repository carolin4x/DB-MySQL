...
-- inner Join entrre produtos e categorias:
...
-- inner Join entre Produtos, Categorias e Usuários: IDEAL NÃO PASSAR DE 3 TABELAS
select * from tb_produtos 
...
select * from tb_produtos 
inner join tb_categorias on tb_produtos.categoria_id = tb_categorias.id 
inner join tb_usuarios on tb_produtos.usuario_id = tb_usuarios.id where tipo = "Aventura";
